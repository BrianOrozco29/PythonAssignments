...
ask that you fill in the blanks in the code below. The
...
def litCricFriend(wordList, text):
    ...
    # PROBLEM 3. Write a string method call that creates a list of
    # the words in text (after they have been lower-cased, and the
